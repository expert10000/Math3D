...
- The pre-MOB24 mobile viewer now has adaptive XY/XZ/YZ reference planes through the origin with subtle fills and major/minor grids, colored X/Y/Z axes, persistent independent plane switches, Show all/Hide all, and an Axes switch. View still needs Auto/manual quality, bounding box, solid/wireframe/edges, and smooth/flat shading. Auto is measured on devices before it becomes the default.
