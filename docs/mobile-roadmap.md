...
| Current in build `150002` | Target | Reason / boundary |
| --- | --- | --- |
...
| --- | --- |
| MOB24 / M0 | `test(mobile): freeze build 150002 physical-device baseline` |
