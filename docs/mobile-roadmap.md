...
- The pre-MOB24 mobile viewer now has an adaptive XY grid, colored X/Y/Z axes, and persistent Grid/Axes controls. View still needs Auto/manual quality, bounding box, solid/wireframe/edges, and smooth/flat shading. Auto is measured on devices before it becomes the default.
